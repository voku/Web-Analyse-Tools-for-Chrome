...
document.addEventListener('DOMContentLoaded', function() {
  getCurrentTabUrl(function(url) {
    ...
    <h3>' + url + '</h3> \
    <ul> \
      <li><a href="https://securityheaders.io/?q=' + urlEncoded + '" target="_blank">Check Security-Header</a></li> \
      <li><a href="http://www.webpagetest.org/" target="_blank">WebPagetest: Speed-Test</a></li> \
      <li><a href="http://tools.pingdom.com/fpt/#!/' + urlEncoded + '" target="_blank">Pingdom: Speed-Test</a></li> \
      <li><a href="http://developers.google.com/speed/pagespeed/insights/?url=' + urlEncoded + '" target="_blank">Google: Speed-Test</a></li> \
      <li><a href="http://cssstats.com/stats?url=' + urlEncoded + '" target="_blank">Show CSS-Statistics</a></li> \
      <li><a href="http://builtwith.com/?' + urlEncoded + '" target="_blank">Recognize Website-Software</a></li> \
      ...
      <li><a href="http://quixapp.com/headers/?r=' + urlEncoded + '" target="_blank">Check Header-Info</a></li> \
      <li><a href="http://linter.structured-data.org/?url=' + urlEncoded + '" target="_blank">Structured Data Linter</a></li> \
      <li><a href="http://www.google.com/webmasters/tools/richsnippets?q=' + urlEncoded + '" target="_blank">Cbeck Rich Snippets</a></li> \
      ...
      <li><a href="https://www.google.com/webmasters/tools/mobile-friendly/?url=' + urlEncoded + '" target="_blank">Mobile-Friendly-Test</a></li> \
    </ul>';
